...
Jun Hu, Wenwen Xia, Xiaolu Zhang, Chilin Fu, Weichang Wu, Zhaoxin Huan, Ang Li, Zuoli Tang, Jun Zhou (2024). Enhancing Sequential Recommendation via LLM-based Semantic Embedding Learning.

게재지: WWW 2024 Companion (industry track)
DOI: 10.1145/3589335.3648307
접근: 전문 미확보 (ACM DL 봇 차단). 초록만.
